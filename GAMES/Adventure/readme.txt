...
It must be compiled on a 128KB/512KB RAM Z80 machine (e.g. running ROMWBW)
...
The main purpose of this experiment was to use the @extern attribute of subroutines, 
in order to have a large source file divided into several smaller source files, each using the @external mechanism.
