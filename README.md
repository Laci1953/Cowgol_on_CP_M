...
-------------------------------------------------------------------
(updated on february, 2025 - aligned to the last version found on the Cowgol site)
...
# Configuring Cowgol source files
---------------------------------

There are more than one way to configure a Cowgol source file.
