...
;end_f128_InputterClosefile:
	...
	; ReadMid0 workspace at ws+3068 length ws+8
f129_ReadMid0:
	ld (ws+3066), hl
	call f122_I_b16
;	ld (ws+3068), hl
...
;end_f129_ReadMid0:
	...
	; ReadMid1 workspace at ws+3068 length ws+4
f130_ReadMid1:
	ld (ws+3066), hl
	call f124_I_b32
	ld (ws+3068), hl
...
;end_f130_ReadMid1:
	...
	; ReadMid2 workspace at ws+3068 length ws+6
f131_ReadMid2:
	ld (ws+3066), hl
	call f124_I_b32
	ld (ws+3068), hl
...
;end_f131_ReadMid2:
	...
	; ReadMid3 workspace at ws+3068 length ws+7
f132_ReadMid3:
	ld (ws+3066), hl
	call f122_I_b16
;	ld (ws+3068), hl
...
;end_f133_ReadMid4:
	...
	; ReadMid5 workspace at ws+3068 length ws+10
f134_ReadMid5:
	ld (ws+3066), hl
	call f122_I_b16
;	ld (ws+3068), hl
...
;end_f134_ReadMid5:
	...
	; ReadMid6 workspace at ws+3068 length ws+1
f135_ReadMid6:
	ld (ws+3066), hl
	call f121_I_b8
;	ld (ws+3068), a
...
;end_f135_ReadMid6:
	...
	; ReadMid7 workspace at ws+3068 length ws+2
f136_ReadMid7:
	ld (ws+3066), hl
	call f122_I_b16
;	ld (ws+3068), hl
...
;end_f137_ReadMid8:
	...
	; ReadMid9 workspace at ws+3068 length ws+2
f138_ReadMid9:
	ld (ws+3066), hl
...
;end_f138_ReadMid9:
	...
	; ReadMid10 workspace at ws+3068 length ws+13
f139_ReadMid10:
	ld (ws+3066), hl
	call f122_I_b16
;	ld (ws+3068), hl
